    ...
    return (function () {
      ...
      function xgenious() {
        ...
        function getStaticOption(e) {
          ...
          t.open("POST", adminUrl + "/get-static-option", !0),
            t.setRequestHeader("Content-Type", "application/json"),
            t.send(JSON.stringify({ static_option: e })),
            (t.onload = function () {
        ...
        function updateStaticOption(e, t) {
          ...
          n.open("POST", adminUrl + "/update-static-option", !0),
            n.setRequestHeader("Content-Type", "application/json"),
            n.send(
              JSON.stringify({ static_option: e, static_option_value: t })
            );
        }
        ...
        function ajpost(e, t, n) {
          ...
          i.open("POST", e, !0),
            ...
            (i.onload = function () {
              ...
              updateStaticOption("item_license_status", e.license_status),
                updateStaticOption("item_license_msg", e.msg),
                setCookie("site_license_check", e.license_status, 1),
                setCookie("item_license_msg", e.msg, 1),
                "not_verified" == e.license_status && notice(e.msg, "warning");
            });
        }
        installPath != null &&
          null == xgmatch &&
          (null == getCookie("site_license_check") &&
            ajpost("https://xgenious.com/api/v2/license/check", {
