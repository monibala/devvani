...
!(function (e) {
  ...
  !(function () {
    ...
    function q(e, a, t) {
      return [
        parseFloat(e[0]) * (l.test(e[0]) ? a / 100 : 1),
        parseFloat(e[1]) * (l.test(e[1]) ? t / 100 : 1),
      ];
    }
    ...
    (j.pos = {
      scrollbarWidth: function () {
        ...
        return (
          ...
          e === (a = s.offsetWidth) && (a = t[0].clientWidth),
          t.remove(),
          (r = e - a)
        );
      },
      getScrollInfo: function (e) {
        var a = e.isWindow || e.isDocument ? "" : e.element.css("overflow-x"),
          ...
          s =
            "scroll" === a ||
            ("auto" === a && e.width < e.element[0].scrollWidth);
        return {
          width:
            "scroll" === t ||
            ("auto" === t && e.height < e.element[0].scrollHeight)
              ? j.pos.scrollbarWidth()
              : 0,
      ...
      (j.fn.pos = function (h) {
        ...
        return (
          ...
          "right" === h.at[0]
            ? (u.left += p)
            : "center" === h.at[0] && (u.left += p / 2),
          "bottom" === h.at[1]
            ? (u.top += d)
            : "center" === h.at[1] && (u.top += d / 2),
          (m = q(v.at, p, d)),
          (u.left += m[0]),
          (u.top += m[1]),
          this.each(function () {
            ...
            "right" === h.my[0]
              ? (o.left -= f)
              : "center" === h.my[0] && (o.left -= f / 2),
              "bottom" === h.my[1]
                ? (o.top -= l)
                : "center" === h.my[1] && (o.top -= l / 2),
              (o.left += n[0]),
              (o.top += n[1]),
              (t = {
                marginLeft: a,
      ...
      (j.ui.pos = {
        ...
        fit: {
          left: function (e, a) {
            ...
            a.collisionWidth > i
              ? 0 < f && l <= 0
                ? ((t = e.left + f + a.collisionWidth - i - r),
                  (e.left += f - t))
                : (e.left =
                    0 < l && f <= 0 ? r : l < f ? r + i - a.collisionWidth : r)
              : 0 < f
              ? (e.left += f)
              : 0 < l
              ? (e.left -= l)
          ...
          top: function (e, a) {
            ...
            a.collisionHeight > i
              ? 0 < f && l <= 0
                ? ((t = e.top + f + a.collisionHeight - i - r),
                  (e.top += f - t))
                : (e.top =
                    0 < l && f <= 0 ? r : l < f ? r + i - a.collisionHeight : r)
              : 0 < f
              ? (e.top += f)
              : 0 < l
              ? (e.top -= l)
        ...
        flip: {
          left: function (e, a) {
            ...
            var t,
              ...
              p = -2 * a.offset[0];
            o < 0
              ? ((t = e.left + h + m + p + a.collisionWidth - c - i) < 0 ||
                  t < x(o)) &&
                (e.left += h + m + p)
              : 0 < n &&
                (0 <
                  (s =
                    e.left - a.collisionPosition.marginLeft + h + m + p - f) ||
                  x(s) < n) &&
                (e.left += h + m + p),
          ...
          top: function (e, a) {
            ...
            var t,
              ...
              p = -2 * a.offset[1];
            o < 0
              ? ((s = e.top + h + m + p + a.collisionHeight - c - i) < 0 ||
                  s < x(o)) &&
                (e.top += h + m + p)
              : 0 < n &&
                (0 <
                  (t = e.top - a.collisionPosition.marginTop + h + m + p - f) ||
                  x(t) < n) &&
                (e.top += h + m + p),
  ...
  (function (e) {
    ...
    "function" == typeof define && define.amd
      ? define(["jquery"], e)
      : window.jQuery && !window.jQuery.fn.iconpicker && e(window.jQuery);
  })(function (l) {
    "use strict";
    var t = function (e) {
        return !1 === e || "" === e || null == e;
      ...
      c = function (e, a) {
        (this._id = c._idCounter++),
          ...
          (this.options.templates = l.extend(
            {},
          ...
          (this.container =
            !!s(this.options.container) && l(this.options.container)),
          !1 === this.container &&
    ...
    (c._idCounter = 0),
      ...
      (c.prototype = {
        ...
        _trigger: function (e, a) {
          (a = a || {}),
            this.element.trigger(
              l.extend({ type: e, iconpickerInstance: this }, a)
            );
        },
        _createPopover: function () {
          ...
          if (
            ...
            this.hasSeparatedSearchInput() &&
              ...
              t(this.options.templates.buttons) ||
          ...
          for (var r in this.options.icons)
            if ("string" == typeof this.options.icons[r].title) {
              ...
              if (
                ...
                i
                  .data("iconpickerValue", this.options.icons[r].title)
                  .on("click.iconpicker", e),
                ...
                for (
                  ...
                  c = c + this.options.icons[r].searchTerms[f] + " ";
        ...
        _isEventInsideIconpicker: function (e) {
          ...
          return !(
            ...
            0 === a.parents(".iconpicker-popover").length
          );
        },
            ...
            this.hasInput() &&
              this.input.on("keyup.iconpicker", function (e) {
                i(
                  ...
                  ? a._updateFormGroupStatus(!1 !== a.getValid(this.value))
                  : a.update(),
                  !0 === a.options.inputSearch &&
                    a.filter(l(this).val().toLowerCase());
              });
        },
        ...
        updatePlacement: function (e, a) {
          (e = e || this.options.placement),
            ...
            (a = !0 === (a = a || this.options.collision) ? "flip" : a);
          var t = {
            at: "right bottom",
            my: "right top",
            of:
          ...
          return (
            ...
            !1 !== t
              ? this.popover
                  ...
                  .css(
                    "maxWidth",
                    l(window).width() - this.container.offset().left - 5
                  )
              : this.popover.css({
                  top: "auto",
                  right: "auto",
        ...
        setValue: function (e) {
          ...
          return !1 !== a
            ? ((this.iconpickerValue = a),
              this._trigger("iconpickerSetValue", { iconpickerValue: a }),
              this.iconpickerValue)
            : (this._trigger("iconpickerInvalid", { iconpickerValue: e }), !1);
        },
        getHtml: function () {
          return (
            '<i class="' +
        ...
        show: function () {
          ...
          l.iconpicker.batch(
            l(".iconpicker-popover.in:not(.inline)").not(this.popover),
            "hide"
          ),
          ...
          return (
            ...
            !0 === a
              ...
              : ((e = this.setSourceValue(e)),
                this._updateFormGroupStatus(!1 !== e)),
      ...
      (l.fn.iconpicker = function (a) {
        return this.each(function () {
          var e = l(this);
          e.data("iconpicker") ||
            e.data("iconpicker", new c(this, "object" == typeof a ? a : {}));
        });
      }),
